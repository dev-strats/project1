...
import {fontSizeBase, primary_color, fifthTextColor } from '../../config';
          ...
          <div className="col-lg-4 col-lg-offset-4 col-sm-6 col-sm-offset-3 col-xs-12">
            <div className="login-center">
              <form id="login_form" action="/" onSubmit={onSubmit}>
                <h3 className="text-center p-b-20  m-t-0">Forgot Password</h3>
                ...
                { !valid.api_type && <p className="text-success m-t-25">{formErrors.api_type}</p> }
                ...
                <div className="m-t-15 m-b-15">
                  Don't have an account? <Link to="/signup" className="link-custom">Signup</Link>
                </div>
              </form>
            </div>
          </div>
